...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch('https://extra-production-980c.up.railway.app/register', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        showMessage('success', 'Registration successful! Redirecting to home...');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Create your account to start using AI-powered email marketing tools.
          </p>
        </div>
        ...
        <div className="glass-card rounded-3xl overflow-hidden shadow-soft-lg p-8 mb-8">
          ...
          <p className="text-gray-600 mb-6 text-center">Enter your details to get started</p>
